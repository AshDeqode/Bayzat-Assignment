...
public interface DeliveryRepository extends CrudRepository<Delivery, Long> {
	...
	//query to fetch top 3 delivery persons whose delivery is highest in between given time frame
	...
	//query to fetch average comission of a delivery man between given time frame
